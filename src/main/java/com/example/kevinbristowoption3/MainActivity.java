...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        username.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                // Enable/disable login and create account based on username and password fields
    ...
    //Info button message when clicked
    ...
    public void clickLogin(View view) {
        ...
        if (database.getAccount(usernameCheck, passwordCheck)){
            ...
            // Make username global for easier access
            usr = usernameCheck;
            // Open activity2 (weight screen)
    ...
    public void clickCreateAccount(View view) {
        ...
        // Validate if account can be created
